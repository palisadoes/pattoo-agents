...
def main():
    ...
    print(args.ini.foreignbbmd)
    print(args.ini.foreignttl)
    print(args.ini.maxapdulengthaccepted)
    print(args.ini.objectidentifier)
    print(args.ini.objectname)
    print(args.ini.segmentationsupported)
    print(args.ini.vendoridentifier)
